      ...
      <div class="mainCon">
        ...
        <div class="previewWrap">
          ...
          <Zoom
            ...
            :imgUrl="skuImage[currentIndex].imgUrl"
            :bigImg="skuImage[currentIndex].imgUrl"
          />
          <!-- 小图列表 -->
        ...
        <div class="InfoWrap">
          ...
          <div class="choose">
            <div class="chooseArea">
              ...
              <dl v-for="attrList in detail.spuSaleAttrList" :key="attrList.id">
                <dt class="title">{{attrList.saleAttrName}}</dt>
                <dd
                  v-for="item in attrList.spuSaleAttrValueList"
                  :key="item.id"
